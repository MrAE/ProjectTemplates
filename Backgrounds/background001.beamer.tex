...
\usepackage{fontspec}
\setsansfont{[RubikMicrobe-Regular.ttf]}
...
\setbeamercolor{background canvas}{bg=JBlue}
...
\begin{textblock}{5}(0,1)
	...
	\begin{tikzpicture}[scale=1, color = white, line width = 2]
		\fill[Purple] (0,0) circle (1cm);
		\fill[Purple] (1,0) circle (1cm);
		\draw (0,0) circle (1cm); 
		\draw (1,0) circle (1cm);
	\end{tikzpicture}
    \end{center}
